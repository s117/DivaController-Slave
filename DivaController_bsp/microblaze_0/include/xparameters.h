...
/* Definitions for peripheral CTRL_BUTTONS_16BIT */
#define XPAR_CTRL_BUTTONS_16BIT_BASEADDR 0x86000000
#define XPAR_CTRL_BUTTONS_16BIT_HIGHADDR 0x8600FFFF
#define XPAR_CTRL_BUTTONS_16BIT_DEVICE_ID 0
#define XPAR_CTRL_BUTTONS_16BIT_INTERRUPT_PRESENT 0
#define XPAR_CTRL_BUTTONS_16BIT_IS_DUAL 0


/* Definitions for peripheral CTRL_DAC_READ_EN */
#define XPAR_CTRL_DAC_READ_EN_BASEADDR 0x86200000
#define XPAR_CTRL_DAC_READ_EN_HIGHADDR 0x8620FFFF
#define XPAR_CTRL_DAC_READ_EN_DEVICE_ID 1
#define XPAR_CTRL_DAC_READ_EN_INTERRUPT_PRESENT 0
#define XPAR_CTRL_DAC_READ_EN_IS_DUAL 0
...
/* Definitions for peripheral LCD_1602_4BIT_INTERFACE */
#define XPAR_LCD_1602_4BIT_INTERFACE_BASEADDR 0x81000000
#define XPAR_LCD_1602_4BIT_INTERFACE_HIGHADDR 0x8100FFFF
#define XPAR_LCD_1602_4BIT_INTERFACE_DEVICE_ID 3
#define XPAR_LCD_1602_4BIT_INTERFACE_INTERRUPT_PRESENT 0
#define XPAR_LCD_1602_4BIT_INTERFACE_IS_DUAL 0


/* Definitions for peripheral LEDS_8BIT */
#define XPAR_LEDS_8BIT_BASEADDR 0x81440000
#define XPAR_LEDS_8BIT_HIGHADDR 0x8144FFFF
#define XPAR_LEDS_8BIT_DEVICE_ID 4
...
#define XPAR_LEDS_POSITIONS_DEVICE_ID 5
...
#define XPAR_PUSH_BUTTONS_5BIT_DEVICE_ID 6
...
/* Canonical definitions for peripheral CTRL_BUTTONS_16BIT */
#define XPAR_GPIO_0_BASEADDR 0x86000000
#define XPAR_GPIO_0_HIGHADDR 0x8600FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_CTRL_BUTTONS_16BIT_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral CTRL_DAC_READ_EN */
#define XPAR_GPIO_1_BASEADDR 0x86200000
#define XPAR_GPIO_1_HIGHADDR 0x8620FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_CTRL_DAC_READ_EN_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 0

/* Canonical definitions for peripheral DIP_SWITCHES_8BIT */
#define XPAR_GPIO_2_BASEADDR 0x81460000
#define XPAR_GPIO_2_HIGHADDR 0x8146FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_DIP_SWITCHES_8BIT_DEVICE_ID
#define XPAR_GPIO_2_INTERRUPT_PRESENT 0
#define XPAR_GPIO_2_IS_DUAL 0

/* Canonical definitions for peripheral LCD_1602_4BIT_INTERFACE */
#define XPAR_GPIO_3_BASEADDR 0x81000000
#define XPAR_GPIO_3_HIGHADDR 0x8100FFFF
#define XPAR_GPIO_3_DEVICE_ID XPAR_LCD_1602_4BIT_INTERFACE_DEVICE_ID
#define XPAR_GPIO_3_INTERRUPT_PRESENT 0
#define XPAR_GPIO_3_IS_DUAL 0

/* Canonical definitions for peripheral LEDS_8BIT */
#define XPAR_GPIO_4_BASEADDR 0x81440000
#define XPAR_GPIO_4_HIGHADDR 0x8144FFFF
#define XPAR_GPIO_4_DEVICE_ID XPAR_LEDS_8BIT_DEVICE_ID
#define XPAR_GPIO_4_INTERRUPT_PRESENT 0
#define XPAR_GPIO_4_IS_DUAL 0

/* Canonical definitions for peripheral LEDS_POSITIONS */
#define XPAR_GPIO_5_BASEADDR 0x81420000
#define XPAR_GPIO_5_HIGHADDR 0x8142FFFF
#define XPAR_GPIO_5_DEVICE_ID XPAR_LEDS_POSITIONS_DEVICE_ID
#define XPAR_GPIO_5_INTERRUPT_PRESENT 0
#define XPAR_GPIO_5_IS_DUAL 0

/* Canonical definitions for peripheral PUSH_BUTTONS_5BIT */
#define XPAR_GPIO_6_BASEADDR 0x81400000
#define XPAR_GPIO_6_HIGHADDR 0x8140FFFF
#define XPAR_GPIO_6_DEVICE_ID XPAR_PUSH_BUTTONS_5BIT_DEVICE_ID
...
/* Definitions for driver DSDAC */
#define XPAR_XDSDAC_NUM_INSTANCES 6

/* Definitions for peripheral CTRL_STICK_L_X */
#define XPAR_CTRL_STICK_L_X_DEVICE_ID 0
#define XPAR_CTRL_STICK_L_X_BASEADDR 0x86400000
#define XPAR_CTRL_STICK_L_X_HIGHADDR 0x8640FFFF


/* Definitions for peripheral CTRL_STICK_L_Y */
#define XPAR_CTRL_STICK_L_Y_DEVICE_ID 1
#define XPAR_CTRL_STICK_L_Y_BASEADDR 0x86600000
#define XPAR_CTRL_STICK_L_Y_HIGHADDR 0x8660FFFF


/* Definitions for peripheral CTRL_STICK_R_X */
#define XPAR_CTRL_STICK_R_X_DEVICE_ID 2
#define XPAR_CTRL_STICK_R_X_BASEADDR 0x86800000
#define XPAR_CTRL_STICK_R_X_HIGHADDR 0x8680FFFF


/* Definitions for peripheral CTRL_STICK_R_Y */
#define XPAR_CTRL_STICK_R_Y_DEVICE_ID 3
#define XPAR_CTRL_STICK_R_Y_BASEADDR 0x86A00000
#define XPAR_CTRL_STICK_R_Y_HIGHADDR 0x86A0FFFF


/* Definitions for peripheral CTRL_TRIGGER_LT */
#define XPAR_CTRL_TRIGGER_LT_DEVICE_ID 4
#define XPAR_CTRL_TRIGGER_LT_BASEADDR 0x86C00000
#define XPAR_CTRL_TRIGGER_LT_HIGHADDR 0x86C0FFFF


/* Definitions for peripheral CTRL_TRIGGER_RT */
#define XPAR_CTRL_TRIGGER_RT_DEVICE_ID 5
#define XPAR_CTRL_TRIGGER_RT_BASEADDR 0x86E00000
#define XPAR_CTRL_TRIGGER_RT_HIGHADDR 0x86E0FFFF


/******************************************************************/

/* Canonical definitions for peripheral CTRL_STICK_L_X */
#define XPAR_DSDAC_0_DEVICE_ID XPAR_CTRL_STICK_L_X_DEVICE_ID
#define XPAR_DSDAC_0_BASEADDR 0x86400000
#define XPAR_DSDAC_0_HIGHADDR 0x8640FFFF

/* Canonical definitions for peripheral CTRL_STICK_L_Y */
#define XPAR_DSDAC_1_DEVICE_ID XPAR_CTRL_STICK_L_Y_DEVICE_ID
#define XPAR_DSDAC_1_BASEADDR 0x86600000
#define XPAR_DSDAC_1_HIGHADDR 0x8660FFFF

/* Canonical definitions for peripheral CTRL_STICK_R_X */
#define XPAR_DSDAC_2_DEVICE_ID XPAR_CTRL_STICK_R_X_DEVICE_ID
#define XPAR_DSDAC_2_BASEADDR 0x86800000
#define XPAR_DSDAC_2_HIGHADDR 0x8680FFFF

/* Canonical definitions for peripheral CTRL_STICK_R_Y */
#define XPAR_DSDAC_3_DEVICE_ID XPAR_CTRL_STICK_R_Y_DEVICE_ID
#define XPAR_DSDAC_3_BASEADDR 0x86A00000
#define XPAR_DSDAC_3_HIGHADDR 0x86A0FFFF

/* Canonical definitions for peripheral CTRL_TRIGGER_LT */
#define XPAR_DSDAC_4_DEVICE_ID XPAR_CTRL_TRIGGER_LT_DEVICE_ID
#define XPAR_DSDAC_4_BASEADDR 0x86C00000
#define XPAR_DSDAC_4_HIGHADDR 0x86C0FFFF

/* Canonical definitions for peripheral CTRL_TRIGGER_RT */
#define XPAR_DSDAC_5_DEVICE_ID XPAR_CTRL_TRIGGER_RT_DEVICE_ID
#define XPAR_DSDAC_5_BASEADDR 0x86E00000
#define XPAR_DSDAC_5_HIGHADDR 0x86E0FFFF
...
/* Definitions for peripheral DDR2_SDRAM */
#define XPAR_DDR2_SDRAM_MPMC_BASEADDR 0xB0000000
...
#define XPAR_RS232_UART_2_BAUDRATE 115200
...
/* Definitions for driver PCIE */
#define XPAR_XPCIE_NUM_INSTANCES 1

/* Definitions for peripheral PCIE_BRIDGE */
#define XPAR_PCIE_BRIDGE_DEVICE_ID 0
#define XPAR_PCIE_BRIDGE_FAMILY virtex5
#define XPAR_PCIE_BRIDGE_BASEADDR 0x85C00000
#define XPAR_PCIE_BRIDGE_HIGHADDR 0x85C0FFFF
#define XPAR_PCIE_BRIDGE_PCIBAR_LEN_0 28
#define XPAR_PCIE_BRIDGE_PCIBAR2IPIFBAR_0 0xb0000000
#define XPAR_PCIE_BRIDGE_PCIBAR_LEN_1 28
#define XPAR_PCIE_BRIDGE_PCIBAR2IPIFBAR_1 0x00000000
#define XPAR_PCIE_BRIDGE_PCIBAR_LEN_2 16
#define XPAR_PCIE_BRIDGE_PCIBAR2IPIFBAR_2 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_PCIBAR_NUM 1
#define XPAR_PCIE_BRIDGE_PCIBAR_AS 1
#define XPAR_PCIE_BRIDGE_IPIFBAR_0 0xe0000000
#define XPAR_PCIE_BRIDGE_IPIFBAR_HIGHADDR_0 0xffffffff
#define XPAR_PCIE_BRIDGE_IPIFBAR2PCIBAR_0 0x00000000
#define XPAR_PCIE_BRIDGE_IPIFBAR_AS_0 0
#define XPAR_PCIE_BRIDGE_IPIFBAR_SPACE_TYPE_0 1
#define XPAR_PCIE_BRIDGE_IPIFBAR_1 0xc0000000
#define XPAR_PCIE_BRIDGE_IPIFBAR_HIGHADDR_1 0xcfffffff
#define XPAR_PCIE_BRIDGE_IPIFBAR2PCIBAR_1 0x00000000
#define XPAR_PCIE_BRIDGE_IPIFBAR_AS_1 0
#define XPAR_PCIE_BRIDGE_IPIFBAR_SPACE_TYPE_1 1
#define XPAR_PCIE_BRIDGE_IPIFBAR_2 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_HIGHADDR_2 0x00000000
#define XPAR_PCIE_BRIDGE_IPIFBAR2PCIBAR_2 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_AS_2 0
#define XPAR_PCIE_BRIDGE_IPIFBAR_SPACE_TYPE_2 1
#define XPAR_PCIE_BRIDGE_IPIFBAR_3 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_HIGHADDR_3 0x00000000
#define XPAR_PCIE_BRIDGE_IPIFBAR2PCIBAR_3 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_AS_3 0
#define XPAR_PCIE_BRIDGE_IPIFBAR_SPACE_TYPE_3 1
#define XPAR_PCIE_BRIDGE_IPIFBAR_4 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_HIGHADDR_4 0x00000000
#define XPAR_PCIE_BRIDGE_IPIFBAR2PCIBAR_4 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_AS_4 0
#define XPAR_PCIE_BRIDGE_IPIFBAR_SPACE_TYPE_4 1
#define XPAR_PCIE_BRIDGE_IPIFBAR_5 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_HIGHADDR_5 0x00000000
#define XPAR_PCIE_BRIDGE_IPIFBAR2PCIBAR_5 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_IPIFBAR_AS_5 0
#define XPAR_PCIE_BRIDGE_IPIFBAR_SPACE_TYPE_5 1
#define XPAR_PCIE_BRIDGE_IPIFBAR_NUM 2
#define XPAR_PCIE_BRIDGE_INCLUDE_BAROFFSET_REG 0
#define XPAR_PCIE_BRIDGE_INCLUDE_RC 0
#define XPAR_PCIE_BRIDGE_ECAM_BASEADDR 0xFFFFFFFF
#define XPAR_PCIE_BRIDGE_ECAM_HIGHADDR 0x00000000


/******************************************************************/

/* Canonical definitions for peripheral PCIE_BRIDGE */
#define XPAR_PCIE_0_DEVICE_ID XPAR_PCIE_BRIDGE_DEVICE_ID
#define XPAR_PCIE_0_FAMILY virtex5
#define XPAR_PCIE_0_BASEADDR 0x85C00000
#define XPAR_PCIE_0_HIGHADDR 0x85C0FFFF
#define XPAR_PCIE_0_PCIBAR_LEN_0 28
#define XPAR_PCIE_0_PCIBAR2IPIFBAR_0 0xb0000000
#define XPAR_PCIE_0_PCIBAR_LEN_1 28
#define XPAR_PCIE_0_PCIBAR2IPIFBAR_1 0x00000000
#define XPAR_PCIE_0_PCIBAR_LEN_2 16
#define XPAR_PCIE_0_PCIBAR2IPIFBAR_2 0xFFFFFFFF
#define XPAR_PCIE_0_PCIBAR_NUM 1
#define XPAR_PCIE_0_IPIFBAR_0 0xe0000000
#define XPAR_PCIE_0_IPIFBAR_HIGHADDR_0 0xffffffff
#define XPAR_PCIE_0_IPIFBAR2PCIBAR_0 0x00000000
#define XPAR_PCIE_0_IPIFBAR_1 0xc0000000
#define XPAR_PCIE_0_IPIFBAR_HIGHADDR_1 0xcfffffff
#define XPAR_PCIE_0_IPIFBAR2PCIBAR_1 0x00000000
#define XPAR_PCIE_0_IPIFBAR_2 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_HIGHADDR_2 0x00000000
#define XPAR_PCIE_0_IPIFBAR2PCIBAR_2 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_3 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_HIGHADDR_3 0x00000000
#define XPAR_PCIE_0_IPIFBAR2PCIBAR_3 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_4 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_HIGHADDR_4 0x00000000
#define XPAR_PCIE_0_IPIFBAR2PCIBAR_4 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_5 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_HIGHADDR_5 0x00000000
#define XPAR_PCIE_0_IPIFBAR2PCIBAR_5 0xFFFFFFFF
#define XPAR_PCIE_0_IPIFBAR_NUM 2
#define XPAR_PCIE_0_INCLUDE_BAROFFSET_REG 0
#define XPAR_PCIE_0_INCLUDE_RC 0
#define XPAR_PCIE_0_ECAM_BASEADDR 0xFFFFFFFF
#define XPAR_PCIE_0_ECAM_HIGHADDR 0x00000000
...
/* Definitions for peripheral SRAM */
#define XPAR_SRAM_MEM0_BASEADDR 0x9AF00000
#define XPAR_SRAM_MEM0_HIGHADDR 0x9AFFFFFF

/******************************************************************/

/* Canonical definitions for peripheral SRAM */
#define XPAR_EMC_0_NUM_BANKS_MEM 1
#define XPAR_EMC_0_MEM0_BASEADDR 0x9AF00000
#define XPAR_EMC_0_MEM0_HIGHADDR 0x9AFFFFFF
...
#define XPAR_RS232_UART_2_INTERRUPT_MASK 0X000001
#define XPAR_XPS_INTC_0_RS232_UART_2_INTERRUPT_INTR 0
#define XPAR_RS232_UART_1_INTERRUPT_MASK 0X000002
#define XPAR_XPS_INTC_0_RS232_UART_1_INTERRUPT_INTR 1
#define XPAR_PUSH_BUTTONS_5BIT_IP2INTC_IRPT_MASK 0X000004
#define XPAR_XPS_INTC_0_PUSH_BUTTONS_5BIT_IP2INTC_IRPT_INTR 2
...
#define XPAR_XPS_INTC_0_MDM_0_INTERRUPT_INTR 4
...
#define XPAR_INTC_0_UARTLITE_2_VEC_ID XPAR_XPS_INTC_0_RS232_UART_2_INTERRUPT_INTR
#define XPAR_INTC_0_UARTLITE_1_VEC_ID XPAR_XPS_INTC_0_RS232_UART_1_INTERRUPT_INTR
#define XPAR_INTC_0_GPIO_6_VEC_ID XPAR_XPS_INTC_0_PUSH_BUTTONS_5BIT_IP2INTC_IRPT_INTR
